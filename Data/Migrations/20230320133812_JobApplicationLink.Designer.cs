...
namespace JobBoard.Data.Migrations
{
    ...
    [Migration("20230320133812_JobApplicationLink")]
    partial class JobApplicationLink
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApplicationUserIndustryModel", b =>
                {
                    b.Property<int>("IndustryPreferencesId")
                        .HasColumnType("int");

                    b.Property<string>("UsersId")
                        .HasColumnType("nvarchar(450)");

                    b.HasKey("IndustryPreferencesId", "UsersId");
            ...
            modelBuilder.Entity("CompetitionModelTagModel", b =>
                {
                    ...
                    b.HasKey("CompetitionsId", "TagsId");

                    b.HasIndex("TagsId");

                    b.ToTable("CompetitionModelTagModel");
                });
            ...
            modelBuilder.Entity("JobBoard.Models.Competitions.CompetitionModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("JobBoard.Models.Industry.IndustryModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("JobBoard.Models.Jobs.JobModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("JobBoard.Models.Users.AwardModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ApplicationUserIndustryModel", b =>
                {
                    b.HasOne("JobBoard.Models.Industry.IndustryModel", null)
                        .WithMany()
                        .HasForeignKey("IndustryPreferencesId")
            ...
            modelBuilder.Entity("JobBoard.Models.Jobs.JobModel", b =>
                {
                    b.HasOne("JobBoard.Models.Industry.IndustryModel", "Industry")
                        .WithMany()
            ...
            modelBuilder.Entity("JobBoard.Models.Users.AwardModel", b =>
                {
                    b.HasOne("JobBoard.Models.Competitions.CompetitionModel", "Competition")
                        .WithMany()
