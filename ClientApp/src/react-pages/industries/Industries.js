...
export default function Industries() {
  ...
  return (
    <>
      ...
      <div className="grid">
        {industries
          .filter((industry) => !(!showEmpty && industry.count === 0))
          .map((industry) => (
            <div
              className="g-col-12 g-col-sm-6 g-col-lg-4 g-col-xxl-3"
              key={industry.name}
            >
    ...
    <div className="card mb-3">
      <div className="card-body">
        ...
        <h6 class="card-subtitle mb-2 text-muted">
          # of careers: {industry.count}
        </h6>
        <a href={`/jobs?industry=${industry.id}`} class="card-link">
          Explore industry
        </a>
      </div>
    </div>
