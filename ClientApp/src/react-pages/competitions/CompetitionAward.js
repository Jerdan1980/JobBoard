...
export default function CompetitionAward() {
  ...
  const createAward = (e) => {
    if (selectedUser == null && rank == null) return;
          ...
          <div class="form-group row mb-2">
            ...
            <div class="col-sm-10">
              <Select
                ...
                classNames={{
                  option: (state) =>
                    state.isSelected ? 'text-light' : 'text-muted',
                }}
              />
            </div>
          </div>
          <div class="form-group row mb-2">
            <label htmlFor="rank" class="col-sm-2 col-form-label">
              Rank:
            </label>
            <div class="col-sm-10">
              <input
      ...
      <div class="form-group row mb-2">
        ...
        <div class="col-sm-10">
          <input
            ...
            id="user"
            value={`${award.userName} (${award.userId})`}
            readOnly
          ></input>
        </div>
      </div>
