      ...
      <div class="row">
        ...
        <div class="col position-relative">
          <div class="position-absolute top-0 end-0">
            <a
              class={'btn btn-primary mx-1' + (!loggedIn ? ' disabled' : '')}
              href={`/competitions/award?id=${competition.id}`}
            >
              Edit Awards
            </a>
            <a
              class={'btn btn-primary mx-1' + (!loggedIn ? ' disabled' : '')}
              href={`/competitions/edit?id=${competition.id}`}
            >
              Edit Competition
            </a>
          </div>
