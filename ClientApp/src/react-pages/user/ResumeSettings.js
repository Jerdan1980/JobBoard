					...
					<div class="row">
						...
						<div class="col">
							...
							<div className="form-group mb-2">
								<label class="form-label" htmlFor="resumeFile">Select file to upload here:</label>
								<input 
									id="resumeFile"
							...
							<button class="btn btn-primary" onClick={handleSubmission}>Submit</button>
						</div>
						...
						{lastModified && (
							<div class="col">
								...
								<div className="form-group mb-2">
									<label class="form-label" htmlFor="resumeDelete"><em><strong>Warning:</strong> This action is irreversible!</em></label>
									<input type="text" class={"form-control " + ((deleteString === oldName) ? "is-valid" : "is-invalid")} id="resumeDelete" value={deleteString} onChange={(e) => setDeleteString(e.target.value)}></input>
